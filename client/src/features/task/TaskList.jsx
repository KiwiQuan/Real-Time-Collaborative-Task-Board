  ...
  return (
    <ul className="taskList flex gap-4 lg:justify-center grow">
      <div className="taskListStatusGrid md:bg-gray-100 gap-2 grid grid-cols-1 md:grid-cols-2 lg:flex gap-10 grow">
        <div className="taskListCompletedList flex flex-col gap-4 grow basis-full p-4 rounded-md bg-green-100/50 border border-green-200 lg:items-center">
        ...
        <div className="taskListNotCompletedList flex flex-col gap-4 grow basis-full p-4 rounded-md bg-red-100/50 border border-red-200 lg:items-center">
