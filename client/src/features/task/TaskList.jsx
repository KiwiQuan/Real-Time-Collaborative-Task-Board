...
export default function TaskList({ tasks, boardId }) {
  return (
    <ul className="taskList flex gap-4 lg:justify-center grow">
      <div className="taskListStatusGrid gap-2 grid grid-cols-1 md:grid-cols-2 lg:flex gap-10 grow">
        <div className="taskListCompletedList flex flex-col gap-4 grow basis-full bg-green-100/50 p-4 rounded-md border border-green-200 lg:justify-center lg:items-center">
        ...
        <div className="taskListNotCompletedList flex flex-col gap-4 grow basis-full bg-red-100/50 p-4 rounded-md border border-red-200 lg:justify-center lg:items-center">
